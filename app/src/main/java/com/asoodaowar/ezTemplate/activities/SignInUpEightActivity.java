...
public class SignInUpEightActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_in_up_eight);
...
//
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new SignInEightFragment(),getString(R.string.sign_in));
        adapter.addFragment(new SignUpEightFragment(),getString(R.string.sign_up));
